			...
			<div class="col-sm-7">
				<div class="panel panel-body">
					...
					<p>
						...
						<p class="adr clearfix">
							<span class="adr-group">
								<span class="street-address">Jalan.Kaligawe raya</span><br>
								<span class="postal-code">P.O. Box 50117</span><br>
								<span class="country-name">Semarang, Indonesia</span>
							</span>
						</p>
					</p>
					<hr />
					<p>
						...
						<span class="editContent"> +6285729885387</span>
					</p>
					<hr />
					...
					<p>
						...
						<a href="#" class="editContent">111202012412@mhs.dinus.ac.id</a>
					</p>
				</div>
			</div>
		</div>
