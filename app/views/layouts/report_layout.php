			...
			<tr>
				...
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">+6285729885387</span></div>
						<!-- <div>Email: <span class="sub-title">info@<?php echo SITE_NAME ?></span></div> -->
						<div>Email: <span class="sub-title">111202012412@mhs.dinus,ac,id</span></div>
						<!-- <div>Web: <span class="sub-title"><?php echo SITE_ADDR ?></span></div> -->
						<div>Web: <span class="sub-title">inventoryumkm.com</span></div>
					</div>
